...
public class VotesGeneralSteps {
    String key;
    ...
    @When("I will create one more vote for this {string} {string} and {string}")
    public void i_will_create_one_more_vote(String sub_id,String image_id,String value) {
    ...
    @Then("i have {string} and {string} in votes")
    public void iHaveImage_idInVotes(String image_id,String sub_id){
        i_check_number_of_votes_for_this(sub_id);
        System.out.println(response.path("image_id").toString());
        Assert.assertTrue(response.path("image_id").toString().contains(image_id));
    }
}
